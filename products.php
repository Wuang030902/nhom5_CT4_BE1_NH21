						...
						<div class="tab-pane  active" id="blockView">
							<ul class="thumbnails">
								...
								if (isset($_GET['keyword'])) :
									if ($_GET['type_id'] != "All") {
										$serchKeyWord = $product->search($_GET['keyword'], $_GET['type_id']);
									} else {
										$serchKeyWord = $product->searchAll($_GET['keyword']);
									}
									...
									if ($_GET['type_id'] != "All") {
										$url = $_SERVER['PHP_SELF'] . "?keyword=" . $_GET['keyword'] . "&type_id=" . $_GET['type_id'];
										$serch3KeyWord = $product->search3($_GET['keyword'], $page, $perPage, $_GET['type_id']);
									} else {
										$url = $_SERVER['PHP_SELF'] . "?keyword=" . $_GET['keyword']."&type_id=All" ;
										$serch3KeyWord = $product->search3All($_GET['keyword'], $page, $perPage);
									}
